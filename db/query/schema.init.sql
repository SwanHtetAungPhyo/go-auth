...
-- name: CreatePasswordResetTable :exec
...
-- name: CreateEmailVerificationTable :exec
...
-- name: CreateSessionIndexes :exec
...
-- name: CreateAccountIndexes :exec
